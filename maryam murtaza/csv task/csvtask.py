...
#to read csv file
csv_1=pd.read_csv("C:\\Users\\Maryam\\Downloads\\files\\Sensor Data.csv")
print("original file\n",csv_1)
...
Dp1=px.density_heatmap(updated_csv,title="Realtionship between Humidity and Temperature over time of day",
                        x="Temperature",
                        y="Humidity",
)
plt.plot(Dp1)
